...
: 정부지원사업 정보 분산으로 인한 "LossTime" 
: 공고들의 상이한 문서 형식과 표현 방식으로 인한 정보 비교 어려움
: 구체적인 상황을 충분히 반영하기 어려운 단순 키워드 중심 검색
: AI 제공 추천 결과의 정확성, 신뢰성 검증 어려움
: 공고 탐색 추후 별도 관리 업무 단절
: 이력 존재 시 중복 지원 제한 여부 개별 확인의 어려움
: 공동 참여 기업 탐색 후, 협업 제안 연결 수단 부족
