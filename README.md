...
| 01. 수집 | 02. 정제 | 03. 저장 | 04. 색인 | 05. 공개 |
|:---:|:---:|:---:|:---:|:---:|
| 공식 제공처 공고 수집 | 데이터 검증·정규화 | MySQL 저장 | Elasticsearch · Qdrant | 통합 검색에 반영 |

> 두 검색 색인이 모두 준비된 후 공고를 공개하며, 실패 시 기존 데이터를 유지하고 다음 동기화에서 재시도합니다.

> Elasticsearch 키워드 색인과 Qdrant 벡터 색인이 모두 준비된 공고만 검색에 반영합니다.  
> 수집 또는 색인에 실패하면 기존 데이터를 유지하고 다음 동기화에서 다시 시도합니다.
